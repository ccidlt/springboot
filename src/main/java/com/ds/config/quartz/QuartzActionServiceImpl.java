...
public class QuartzActionServiceImpl implements IQuartzActionService {
    ...
    public void addJob(Class<? extends QuartzJobBean> jobClass,
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("添加告警定时任务失败!");
        }
    }
    ...
    public void addJob(Class<? extends QuartzJobBean> jobClass,
                       String jobName,
                       String jobGroupName,
                       String jobTime) throws Exception {
    ...
    public void addJob(Class<? extends QuartzJobBean> jobClass,
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("告警定时任务运行失败");
        }
    }
    ...
    public void updateJob(String jobName,
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("告警定时任务更新失败");
        }
    }
    ...
    public void deleteJob(String jobName, String jobGroupName) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("告警定时任务删除失败");
        }
    }
    ...
    public void pauseJob(String jobName, String jobGroupName) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("告警定时任务暂停失败");
        }
    }
    ...
    public void resumeJob(String jobName, String jobGroupName) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("告警定时任务恢复失败");
        }
    }
    ...
    public List<Map<String, Object>> queryAllJob() throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("查询告警定时任务列表失败");
        }
        return jobList;
    }
    ...
    public List<Map<String, Object>> queryRunJob() throws Exception {
        ...
        try {
            ...
            e.printStackTrace();
            throw new Exception("查询告警定时任务运行任务列表失败");
        }
        return jobList;
    }
}
